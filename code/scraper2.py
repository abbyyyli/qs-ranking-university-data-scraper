...
def generate_csv_from_data(master_list,file_name='qs_university_ranking_2025'):
...
def main():
    ...
    url = f"https://www.topuniversities.com/world-university-rankings/2025?page={start_page}"
